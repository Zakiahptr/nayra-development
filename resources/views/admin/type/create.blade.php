@extends('admin.templatesAdmin.app' , ['title' => ' Tambah Tipe Perumahan'])

@section('content')
<section class="section">
    <x-admins.breadcrumb>
        <x-slot name="title">Tambah Tipe Perumahan</x-slot>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control @error('type_name') is-invalid @enderror"
                         name="type_name" id="inputType" value="{{old('type_name')}}">
                         @error('type_name')
                         <div class="text-danger">{{ $message }}</div>
                         @enderror
                    </div>
